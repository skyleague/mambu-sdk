...
import { Centre, ErrorResponse, GetAllResponse } from './rest.zod.js'
...
export class MambuCentres {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('centres', {
                searchParams: query ?? {},
    ...
    public getById({
        ...
        query,
        auth = [['apiKey'], ['basic']],
    }: { path: { centreId: string }; query?: { detailsLevel?: string }; auth?: string[][] | string[] }): Promise<
