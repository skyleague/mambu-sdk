...
/**
 * configuration/endofdayprocessing.yaml
 */
export class MambuEndOfDayProcessingConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/endofdayprocessing.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/endofdayprocessing.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
