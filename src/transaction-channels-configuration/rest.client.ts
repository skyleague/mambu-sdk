 ...
 */
export class MambuTransactionChannelsConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/transactionchannels.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/transactionchannels.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
