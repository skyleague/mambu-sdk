 ...
 */
export class MambuInternalControlsConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/internalcontrols.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/internalcontrols.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
