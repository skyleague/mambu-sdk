...
import { ErrorResponse, GetAllResponse, LoanProduct, PatchRequest } from './rest.zod.js'
...
export class MambuLoanProducts {
    ...
    public create({
        ...
        headers,
        auth = [['apiKey'], ['basic']],
    }: { body: LoanProduct; headers?: { 'Idempotency-Key'?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public delete({
        path,
        auth = [['apiKey'], ['basic']],
    }: { path: { loanProductId: string }; auth?: string[][] | string[] }): Promise<
    ...
    public getById({
        ...
        query,
        auth = [['apiKey'], ['basic']],
    }: { path: { loanProductId: string }; query?: { detailsLevel?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public patch({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: PatchRequest; path: { loanProductId: string }; auth?: string[][] | string[] }): Promise<
        | SuccessResponse<'204', unknown>
        | FailureResponse<'400', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'401', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'403', ErrorResponse, 'response:statuscode'>
    ...
    public update({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: LoanProduct; path: { loanProductId: string }; auth?: string[][] | string[] }): Promise<
        | SuccessResponse<'200', LoanProduct>
        | FailureResponse<'400', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'401', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'403', ErrorResponse, 'response:statuscode'>
