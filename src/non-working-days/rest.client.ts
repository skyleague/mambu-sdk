...
import { ErrorResponse, NonWorkingDays } from './rest.type.js'

/**
 * organization/holidays/nonworkingdays
 */
export class MambuNonWorkingDays {
    public client: Got
    ...
    /**
     * Allows retrieval of the non working days.
     */
    ...
    /**
     * Non working days retrieved.
     */
    public async update({ body, auth = [['apiKey'], ['basic']] }: { body: NonWorkingDays; auth?: string[][] | string[] }) {
        this.validateRequestBody(NonWorkingDays, body)
