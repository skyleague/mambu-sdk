...
import { CustomFieldMeta, ErrorResponse } from './rest.zod.js'

/**
 * customfields
 */
export class MambuCustomFields {
    ...
    public getById({
        ...
        query,
        auth = [['apiKey'], ['basic']],
    }: { path: { customfieldId: string }; query?: { detailsLevel?: string }; auth?: string[][] | string[] }): Promise<
