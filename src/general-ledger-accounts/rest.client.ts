...
import { CreateRequest, CreateResponse, ErrorResponse, GLAccount, GetAllResponse, PatchRequest } from './rest.zod.js'
...
export class MambuGeneralLedgerAccounts {
    ...
    public patch({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: PatchRequest; path: { glAccountId: string }; auth?: string[][] | string[] }): Promise<
