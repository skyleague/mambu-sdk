...
import { BaseTemplateConfiguration, ErrorResponse, UpdateTemplateRequest } from './rest.zod.js'

/**
 * templates
 */
export class MambuTemplates {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('templates', {
                json: _body.right,
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).delete(`templates/${path.templateId}`, {}),
            {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`templates/${path.templateId}`, {
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).patch(`templates/${path.templateId}`, {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
