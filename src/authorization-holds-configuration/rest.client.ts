...
/**
 * configuration/authorizationholds.yaml
 */
export class MambuAuthorizationHoldsConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/authorizationholds.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/authorizationholds.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
