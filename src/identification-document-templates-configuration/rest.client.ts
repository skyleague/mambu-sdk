...
/**
 * configuration/iddocumenttemplates.yaml
 */
export class MambuIdentificationDocumentTemplatesConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/iddocumenttemplates.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/iddocumenttemplates.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
