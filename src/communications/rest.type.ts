...
export interface CommunicationMessage {
    ...
    senderKey?: string
    /**
     * The date the communication message was actually sent (as UTC)
     */
    sendDate?: string
    /**
    ...
    subject?: string
    /**
     * The loan account about which the message was sent
     */
    loanAccountKey?: string
    /**
     * The destination (phone number or email address) this communication message was sent to
     */
    destination?: string
    /**
    ...
    failureCause?: string
    /**
     * The date the communication message was created (as UTC)
     */
    creationDate?: string
    /**
    ...
    /**
     * The actual contents (body) of the message
     */
    body?: string
    /**
    ...
    userKey?: string
    /**
     * The repayment about which the message was sent
     */
    repaymentKey?: string
    /**
    ...
    failureReason?:
        ...
        | 'OTHER'
    /**
     * The encoded key of the communication message, auto generated, unique
     */
    encodedKey?: string
    /**
    ...
    /**
     * The event this message was sent for
     */
    event?:
        | 'MANUAL'
        | 'DO_NOTHING'
...
/**
 * Allows specifying a time interval from which notifications will be resent
 */
