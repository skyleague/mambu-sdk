...
import { ErrorResponse, ExchangeRate, ExchangeRateInput, GetAllResponse } from './rest.zod.js'

/**
 * currencies/rates
 */
export class MambuExchangeRate {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post(`currencies/${path.currencyCode}/rates`, {
                json: _body.right,
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`currencies/${path.currencyCode}/rates`, {
                searchParams: query ?? {},
