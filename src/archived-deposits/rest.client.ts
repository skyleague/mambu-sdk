...
import { ArchivedDepositTransaction, ErrorResponse, FilterCriteriaValueDateBetweenDTO, SearchResponse } from './rest.zod.js'

/**
 * archive/deposits/transactions/customfields
 */
export class MambuArchivedDeposits {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`archive/deposits/transactions/customfields/${path.transactionId}`, {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('archive/deposits/transactions/customfields:search', {
                json: _body.right,
                searchParams: query ?? {},
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
