...
import { ErrorResponse, GetAllResponse, TransactionChannel } from './rest.zod.js'
...
export class MambuTransactionChannels {
    ...
    public create({
        ...
        headers,
        auth = [['apiKey'], ['basic']],
    }: { body: TransactionChannel; headers?: { 'Idempotency-Key'?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public delete({
        path,
        auth = [['apiKey'], ['basic']],
    }: { path: { transactionChannelId: string }; auth?: string[][] | string[] }): Promise<
    ...
    public getAll({
        query,
        auth = [['apiKey'], ['basic']],
    }: { query?: { detailsLevel?: string; transactionChannelState?: string }; auth?: string[][] | string[] } = {}): Promise<
    ...
    public update({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: TransactionChannel; path: { transactionChannelId: string }; auth?: string[][] | string[] }): Promise<
