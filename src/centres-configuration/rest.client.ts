...
/**
 * configuration/centres.yaml
 */
export class MambuCentresConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/centres.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/centres.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
