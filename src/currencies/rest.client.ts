...
import { CurrencyDetails, ErrorResponse, GetAllResponse } from './rest.zod.js'
...
export class MambuCurrencies {
    ...
    public create({
        ...
        headers,
        auth = [['apiKey'], ['basic']],
    }: { body: CurrencyDetails; headers?: { 'Idempotency-Key'?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public delete({
        path,
        auth = [['apiKey'], ['basic']],
    }: { path: { currencyCode: string }; auth?: string[][] | string[] }): Promise<
    ...
    public get({
        ...
        query,
        auth = [['apiKey'], ['basic']],
    }: { path: { currencyCode: string }; query?: { detailsLevel?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public update({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: CurrencyDetails; path: { currencyCode: string }; auth?: string[][] | string[] }): Promise<
        | SuccessResponse<'200', CurrencyDetails>
        | FailureResponse<'400', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'401', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'403', ErrorResponse, 'response:statuscode'>
