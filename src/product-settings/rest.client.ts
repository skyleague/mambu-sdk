...
import { ErrorResponse, ProductSettings, ProductSettingsSearchCriteria, SearchProductSettingsResponse } from './rest.zod.js'

/**
 * profitsharing/product-settings
 */
export class MambuProductSettings {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('profitsharing/product-settings', {
                json: _body.right,
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`profitsharing/product-settings/${path.productSettingsId}`, {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('profitsharing/product-settings:search', {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).put(`profitsharing/product-settings/${path.productSettingsId}`, {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
