...
import { ErrorResponse, WebhookNotificationSettings } from './rest.zod.js'

/**
 * notificationsettings/webhook
 */
export class MambuNotificationSettings {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('notificationsettings/webhook', {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).put('notificationsettings/webhook', {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
