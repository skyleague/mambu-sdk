...
import { ErrorResponse, GetPoolsResponse, Pool, PoolSettings } from './rest.zod.js'

/**
 * profitsharing/pools
 */
export class MambuPools {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('profitsharing/pools', {
                json: _body.right,
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post(`profitsharing/pools/${path.poolId}/settings`, {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json', ...headers },
            }),
            {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`profitsharing/pools/${path.poolId}`, {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('profitsharing/pools', {
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`profitsharing/pools/${path.poolId}/settings/${path.poolSettingsId}`, {
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
                200: PoolSettings,
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).put(`profitsharing/pools/${path.poolId}`, {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).put(`profitsharing/pools/${path.poolId}/settings/${path.poolSettingsId}`, {
                json: _body.right,
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
            {
