...
import { DepositAccountBalanceSummarySearchCriteria, ErrorResponse, GetAllResponse, SearchResponse } from './rest.zod.js'

/**
 * deposits/balanceSummary
 */
export class MambuDepositAccountBalanceSummary {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get(`deposits/${path.depositAccountId}/balanceSummary`, {
                searchParams: query ?? {},
    ...
    > {
        ...
        return this.awaitResponse(
            this.buildClient(auth).post('deposits/balanceSummary:search', {
                json: _body.right,
                searchParams: query ?? {},
                headers: { Accept: 'application/vnd.mambu.v2+json' },
            }),
