...
export class MambuOrganizationSetup {
    ...
    /**
     * Allows retrieval of organization setup.
     */
    ...
    /**
     * Updates an existing organization setup
     */
    public async updateOrganizationSetup({
        body,
        auth = [['apiKey'], ['basic']],
    }: {
        ...
        this.validateRequestBody(OrganizationSetup, body)
