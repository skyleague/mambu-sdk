...
/**
 * configuration/loanrisklevels.yaml
 */
export class MambuLoanRiskLevelsConfiguration {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).get('configuration/loanrisklevels.yaml', {
    ...
    > {
        return this.awaitResponse(
            this.buildClient(auth).put('configuration/loanrisklevels.yaml', {}),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
