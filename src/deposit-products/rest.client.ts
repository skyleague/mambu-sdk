...
export class MambuDepositProducts {
    ...
    public create({
        ...
        headers,
        auth = [['apiKey'], ['basic']],
    }: { body: DepositProduct; headers?: { 'Idempotency-Key'?: string }; auth?: string[][] | string[] }): Promise<
        | FailureResponse<'102', unknown, 'response:statuscode'>
    ...
    public delete({
        path,
        auth = [['apiKey'], ['basic']],
    }: { path: { depositProductId: string }; auth?: string[][] | string[] }): Promise<
    ...
    public getById({
        ...
        query,
        auth = [['apiKey'], ['basic']],
    }: { path: { depositProductId: string }; query?: { detailsLevel?: string }; auth?: string[][] | string[] }): Promise<
    ...
    public patch({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: PatchRequest; path: { depositProductId: string }; auth?: string[][] | string[] }): Promise<
        | SuccessResponse<'204', unknown>
        | FailureResponse<'400', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'401', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'403', ErrorResponse, 'response:statuscode'>
    ...
    public update({
        ...
        path,
        auth = [['apiKey'], ['basic']],
    }: { body: DepositProduct; path: { depositProductId: string }; auth?: string[][] | string[] }): Promise<
        | SuccessResponse<'200', DepositProduct>
        | FailureResponse<'400', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'401', ErrorResponse, 'response:statuscode'>
        | FailureResponse<'403', ErrorResponse, 'response:statuscode'>
